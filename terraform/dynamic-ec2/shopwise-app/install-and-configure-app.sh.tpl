...
sudo aws s3 cp s3://aosnote-project-web-files/shopwise.zip /var/www/html
...
sudo aws s3 cp s3://aosnote-app-service-provider-files/shopwise-AppServiceProvider.php /var/www/html/app/Providers/AppServiceProvider.php
